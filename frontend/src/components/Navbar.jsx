    ...
    <nav className="flex items-center justify-between flex-wrap bg-teal-500 p-6" style={{width: '100vw'}}>
      ...
      <div className="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
        ...
        <div>
          ...
          <a href="/createaccount" className="inline-block text-sm px-4 py-2 leading-none border rounded text-white border-white hover:border-transparent hover:text-teal-500 hover:bg-white mt-4 lg:mt-0 mr-4">Create Account</a>
        </div>
      </div>
    </nav>
    )
